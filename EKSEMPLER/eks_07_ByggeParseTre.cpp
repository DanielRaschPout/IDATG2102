 ...
 *   til noder. ALLE BLADNODENE inneholder EN bokstav, og ALLE INTERNE noder
 *   inneholder KUN '+' eller '*'. Til slutt ligger det KUN en peker til
 *   treets rot tilbake på stakken.
 *
 *   Algoritme: - Leser ett og ett tegn (bokstav, '+' eller '*')
 *              - Er det en bokstav, push'es den bare på stakken
 *              - Er det '+' eller '*', pop'es av stakken noder som blir høyre
 *                og venstre subtre, før rotnoden selv push'es på stakken
 *
 *   NB: Postfix-utrykket MÅ bestå av kun enkelttegn (bokstaver), '+' og '*'.
